# R_Prob_Condicional_prerrequisito.R
#
# Instalación los paquetes necesarios y
# Preparación los archivos de datos, desde
# https://github.com/hllinas/DatosPublicos
# para el tutorial Probabilidad Condicional
# 
