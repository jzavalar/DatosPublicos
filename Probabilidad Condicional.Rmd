...
author: "Dr. rer. nat. Humberto LLinás Solano"
date: "2023-09-18"
output: html_document
source: https://rpubs.com/hllinas/R_Prob_Condicional
---
...
El paquete `prob` ha ido archivado, por lo que no está disponible para su instalación desde CRAN. Sin embargo, es posible instalarlo desde GitHub con el paquete `remotes`. Ejecute el script: 

Adicionalmente, se instalan tres paquetes más, `devtools`, `repmis` y `rio`, con las siguientes instrucciones:
...
# exportar dataframe en memoria
export(datosCompleto,"./Estudiantes.Rdata")
export(datosCompleto,"./clipboard.csv")
export(datosCompleto,"./Estudiantes.Rdata")
export(datosCompleto,"./clipboard.csv")

# cambiar el nombre de archivo
# archivo a renombrar
archivo <- './clipboard.csv'
archivo_renombrado <- './clipboard'

# Checa si existe el archivo
if(file.exists(archivo)){
  # Renombrar el archivo
  file.rename(archivo,archivo_renombrado)
}else{
