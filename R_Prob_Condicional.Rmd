...
```
-----------
N.B. Este tutorial corresponde a una versión actualizada del tutorial [https://rpubs.com/hllinas/R_Prob_Condicional](https://rpubs.com/hllinas/R_Prob_Condicional), del dr. del dr. Humberto LLinás, convertido a RMarkdown; por lo que sólo se han actualizado algunos aspectos para la reproducción del mismo, sin errores, en 2023, desde RStudio.
-------------------
